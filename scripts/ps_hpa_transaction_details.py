...
high_priority_access = AccountType.objects.get(type_id='PS-HPA')

applications = Application.objects.filter(account_type=high_priority_access, payment_mode='Project').order_by('pi_time')

...
quarterly_access = AccountType.objects.get(type_id='HPC2013-QA')

applications = Application.objects.filter(account_type=quarterly_access, payment_mode='Project').order_by('pi_time')
